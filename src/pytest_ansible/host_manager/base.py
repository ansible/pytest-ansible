...
class BaseHostManager:
    ...
    def __init__(self, *args, **kwargs) -> None:  # type: ignore[no-untyped-def]  # noqa: ANN002, ANN003, ANN101, ARG002
        """Fixme."""
        self.options = kwargs
    ...
    def _default_dispatcher(self, **kwargs):  # type: ignore[no-untyped-def]  # noqa: ANN003, ANN101, ANN202
        pass

    def get_extra_inventory_hosts(self, host_pattern=None):  # type: ignore[no-untyped-def]  # noqa: ANN001, ANN101, ANN201
        """Fixme."""
        try:
    ...
    def get_extra_inventory_groups(self):  # type: ignore[no-untyped-def]  # noqa: ANN101, ANN201
        """Fixme."""
        try:
    ...
    def has_matching_inventory(self, host_pattern):  # type: ignore[no-untyped-def]  # noqa: ANN001, ANN101, ANN201
