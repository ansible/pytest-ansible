...
class BaseHostManager:
    ...
    def _default_dispatcher(self, **kwargs):  # type: ignore[no-untyped-def]
        pass

    def get_extra_inventory_hosts(self, host_pattern=None):  # type: ignore[no-untyped-def]
        """Fixme."""
        try:
    ...
    def get_extra_inventory_groups(self):  # type: ignore[no-untyped-def]
        """Fixme."""
        try:
    ...
    def has_matching_inventory(self, host_pattern):  # type: ignore[no-untyped-def]
