...
def get_host_manager(*args, **kwargs) -> BaseHostManager:  # type: ignore[no-untyped-def]
    ...
    if has_ansible_v213:
        ...
        from pytest_ansible.host_manager.v212 import HostManagerV212 as HostManager  # type: ignore[assignment]
    else:
