...
class ModuleResult(collections.UserDict):  # type: ignore[type-arg]
    ...
    def _check_key(self, key):  # type: ignore[no-untyped-def]  # ruff: ignore[missing-type-function-argument, missing-return-type-private-function]
        # if 'results' in self:
    ...
    @property
    def is_ok(self):  # type: ignore[no-untyped-def]  # ruff: ignore[missing-return-type-undocumented-public-function]
        """Fixme."""
        return not (self.is_changed or self.is_unreachable or self.is_skipped or self.is_failed)

    @property
    def is_changed(self):  # type: ignore[no-untyped-def]  # ruff: ignore[missing-return-type-undocumented-public-function]
        """Fixme."""
        return self._check_key("changed")  # type: ignore[no-untyped-call]

    @property
    def is_unreachable(self):  # type: ignore[no-untyped-def]  # ruff: ignore[missing-return-type-undocumented-public-function]
        """Fixme."""
        return self._check_key("unreachable")  # type: ignore[no-untyped-call]

    @property
    def is_skipped(self):  # type: ignore[no-untyped-def]  # ruff: ignore[missing-return-type-undocumented-public-function]
        """Fixme."""
        return self._check_key("skipped")  # type: ignore[no-untyped-call]

    @property
    def is_failed(self):  # type: ignore[no-untyped-def]  # ruff: ignore[missing-return-type-undocumented-public-function]
        """Fixme."""
        return self._check_key("failed") or self.get("rc", 0) != 0  # type: ignore[no-untyped-call]

    @property
    def is_successful(self):  # type: ignore[no-untyped-def]  # ruff: ignore[missing-return-type-undocumented-public-function]
        """Fixme."""
...
class AdHocResult:
    ...
    def __init__(self, **kwargs) -> None:  # type: ignore[no-untyped-def]  # ruff: ignore[missing-type-kwargs]
        ...
        for kwarg in required_kwargs:
            assert kwarg in kwargs, f"Missing required keyword argument '{kwarg}'"  # ruff: ignore[assert]
    ...
    def items(self):  # type: ignore[no-untyped-def]  # ruff: ignore[missing-return-type-undocumented-public-function]
        """Return a list of tuples containing the inventory host key, and the ModuleResult instance."""  # ruff: ignore[docstring-missing-yields, line-too-long]
        for k in self.contacted:
            yield (k, getattr(self, k))

    def values(self):  # type: ignore[no-untyped-def]  # ruff: ignore[missing-return-type-undocumented-public-function]
