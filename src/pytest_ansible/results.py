...
class ModuleResult(dict):  # type: ignore[type-arg]
    ...
    def _check_key(self, key):  # type: ignore[no-untyped-def]  # noqa: ANN001, ANN101, ANN202
        # if 'results' in self:
    ...
    @property
    def is_ok(self):  # type: ignore[no-untyped-def]  # noqa: ANN101, ANN201
        """Fixme."""
        return not (self.is_changed or self.is_unreachable or self.is_skipped or self.is_failed)

    @property
    def is_changed(self):  # type: ignore[no-untyped-def]  # noqa: ANN101, ANN201
        """Fixme."""
        return self._check_key("changed")  # type: ignore[no-untyped-call]

    @property
    def is_unreachable(self):  # type: ignore[no-untyped-def]  # noqa: ANN101, ANN201
        """Fixme."""
        return self._check_key("unreachable")  # type: ignore[no-untyped-call]

    @property
    def is_skipped(self):  # type: ignore[no-untyped-def]  # noqa: ANN101, ANN201
        """Fixme."""
        return self._check_key("skipped")  # type: ignore[no-untyped-call]

    @property
    def is_failed(self):  # type: ignore[no-untyped-def]  # noqa: ANN101, ANN201
        """Fixme."""
        return self._check_key("failed") or self.get("rc", 0) != 0  # type: ignore[no-untyped-call]

    @property
    def is_successful(self):  # type: ignore[no-untyped-def]  # noqa: ANN101, ANN201
        """Fixme."""
...
class AdHocResult:
    ...
    def __getitem__(self, item):  # type: ignore[no-untyped-def]  # noqa: ANN001, ANN101, ANN204
    ...
    def __getattr__(self, attr):  # type: ignore[no-untyped-def]  # noqa: ANN001, ANN101, ANN204
    ...
    def keys(self):  # type: ignore[no-untyped-def]  # noqa: ANN101, ANN201
        """Return a list of contacted inventory hosts."""
        return self.contacted.keys()

    def items(self):  # type: ignore[no-untyped-def]  # noqa: ANN101, ANN201
    ...
    def values(self):  # type: ignore[no-untyped-def]  # noqa: ANN101, ANN201
